...
nserror netsurf_init(const char *store_path)
{
	...
	image_cache_parameters.limit = hlcache_parameters.llcache.limit / 4.0;

	/* image cache hysteresis is 20% of the image cache size */
	image_cache_parameters.hysteresis = image_cache_parameters.limit / 5.0;
	...
	hlcache_parameters.llcache.store.hysteresis = hlcache_parameters.llcache.store.limit / 5.0;
